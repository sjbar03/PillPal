...
class PalApplication(tk.Tk):
    ...
    def __init__(self, col_names=[], contents:list[list[str]]=[]):
        ...
        THEME_N = 'default'
        ttk.Style().theme_use(THEME_N)
        bg_color = ttk.Style().lookup(THEME_N, 'background')
    ...
    def add_table(self, col_names, contents):
        self.table = ListTable(self, col_names=col_names, contents=contents, col_sizes= [25,40,25,10], width=100)
